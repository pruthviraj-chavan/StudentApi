...
namespace StudentApi.Data.Repository
{
    public class StudentRepository : CollegeRepository<Student> ,  IStudentRepository
    {
        ...
        public Task<List<Student>> GetAllByFeeStatusAsync(int FeeStatus)
        {
            //write code for fee status
            return null;
        }
        ...
        //} 
        //these methods are present in collegerepository which is common repo 
